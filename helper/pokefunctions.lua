function remove(self, card, context)
  play_sound('tarot1')
  card.T.r = -0.2
...
function evolve(self, card, context, forced_key)
...
function level_evo(self, card, context, forced_key)
...
function item_evo(self, card, context, forced_key)
...
function scaling_evo(self, card, context, forced_key, current, target)
