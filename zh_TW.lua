    ...
    descriptions = {
        ...
        Joker = {
            ...
            j_poke_espeon = {
                ...
                text = {
                    "每張打出的{C:attention}#3#{}",
                    "會{C:attention}額外觸發{}一次",
                    "{br:3}此為分隔線",
                    "每張打出的{C:attention}萬能{}牌",
                    "會在得分時會給予{X:red,C:white}X#2#{}倍數",
                    "{C:inactive,s:0.7}牌級在每個回合變更{}"
                } 
            },
            j_poke_umbreon = {
                name = '月亮伊布',
            ...
            j_poke_charjabug = {
                name = '蟲電寶',
                text = {
                    "每張持有的{X:lightning, C:black}電{}屬性小丑牌",
                    "將給予{C:mult}+#1#{}倍數",
                     "{C:inactive}（目前將給予{C:mult}#2#{C:inactive}倍數）",
                    "{C:inactive}（使用{} {C:attention}雷之石{}{C:inactive}後進化）"
                }  
            ...
            j_poke_vikavolt = {
                name = '鍬農炮蟲',
                text = {
                    "每張持有的{X:lightning, C:black}雷{}屬性小丑牌",
