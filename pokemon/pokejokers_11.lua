...
return {
  ...
  list = {delcatty, aron, lairon, aggron, meditite, medicham, volbeat, illumise, roselia, wailmer, wailord, carvanha, sharpedo, numel, camerupt, mega_camerupt, torkoal, spinda},
}
