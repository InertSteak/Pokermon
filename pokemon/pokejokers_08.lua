...
local mega_skarmory = {
  ...
  calculate = function(self, card, context)
    if context.individual and context.cardarea == G.play and
      ...
      local gold_or_steel_count = #pokermon.filter(
        G.hand.cards,
        function(hand_card)
          return SMODS.has_enhancement(hand_card, 'm_steel')
              or SMODS.has_enhancement(hand_card, 'm_gold')
      ...
      local Xmult = 1 + gold_or_steel_count * card.ability.extra.Xmult_multi
...
return {name = "Pokemon Jokers 211-240",
        list = {qwilfish, scizor, mega_scizor, shuckle, heracross, mega_heracross, sneasel, teddiursa, ursaring, slugma, magcargo, swinub, piloswine, corsola, remoraid, octillery, delibird, mantine, skarmory, mega_skarmory, houndour, houndoom, mega_houndoom, kingdra, phanpy, donphan, porygon2, stantler, smeargle, tyrogue, hitmontop, smoochum, elekid, magby},
}
