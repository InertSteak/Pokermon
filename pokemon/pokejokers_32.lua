...
local shroodle = {
  ...
  calculate = function(self, card, context)
    ...
    return scaling_evo(self, card, context, "j_poke_grafaiai", card.ability.extra.count, self.config.evo_rqmt)
  end,
...
return {name = "Pokemon Jokers 931-960", 
        list = {charcadet, armarouge, ceruledge, shroodle, grafaiai, bramblin, brambleghast, tinkatink, tinkatuff, tinkaton, wiglett},
}
