...
matching_energy = function(card)
  ...
  if card.ability.extra and type(card.ability.extra) == "table" and card.ability.extra.ptype and card.ability.extra.ptype ~= "Stellar"
      and card.ability.extra.ptype ~= "Bird" and not type_sticker_applied(card) then
