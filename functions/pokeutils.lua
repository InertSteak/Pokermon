      ...
      if #keys > 1 then
        ...
        for k, v in ipairs(keys) do
          ...
          if G.P_CENTERS[v]['set'] == 'Joker' and not (G.P_CENTERS[v]['stage'] == card.config.center.stage) and not -- Excludes the same stage mons in an evo line
              ...
              (G.P_CENTERS[v]['set'] == 'Joker' and G.P_CENTERS[v]['aux_poke'] == true and G.P_CENTERS[v]['stage'] == card.config.center.stage) then -- Checks for forms (which have the same stage i.e. Jirachi, Rotom)
